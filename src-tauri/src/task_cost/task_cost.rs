...
fn judge(
    ...
    let mentioned = resolve_distinct(
        todos,
        attr.mentions.iter().map(String::as_str),
        Some(sess_proj),
    );
...
mod tests {
    use super::*;
    use crate::board::todos::StatusChange;
    ...
    fn interval_fallback_needs_exactly_one_matching_task() {
        ...
        t1.status_history = vec![
            StatusChange {
                ...
                at: "2026-07-10T10:00:00Z".into(),
            },
            StatusChange {
                status: "review".into(),
                at: "2026-07-10T18:00:00Z".into(),
            },
        ];
