...
impl AppConfig {
    pub fn from_value_lenient(v: &Value) -> Self {
        ...
        let g = |k: &str| m.get(k);
        AppConfig {
            session_key: lenient_string(g("session_key"), d.session_key).trim().to_string(),
            ...
            notifications_enabled: lenient_bool(g("notifications_enabled"), d.notifications_enabled),
            ...
            todo_notifications_enabled: lenient_bool(g("todo_notifications_enabled"), d.todo_notifications_enabled),
            service_status_enabled: lenient_bool(g("service_status_enabled"), d.service_status_enabled),
            service_status_interval: lenient_u64(g("service_status_interval"), d.service_status_interval),
            service_status_notify: lenient_bool(g("service_status_notify"), d.service_status_notify),
            memory_bloat_enabled: lenient_bool(g("memory_bloat_enabled"), d.memory_bloat_enabled),
            runtime_insights_enabled: lenient_bool(g("runtime_insights_enabled"), d.runtime_insights_enabled),
            runtime_insight_kinds: lenient_string_list(g("runtime_insight_kinds"), d.runtime_insight_kinds),
...
mod tests {
    ...
    fn string_numbers_and_null_strings_are_tolerated() {
        let raw = BASE_JSON
            ...
            .replace("\"quiet_hours_start\": \"23:00\"", "\"quiet_hours_start\": null")
            .replace("\"auto_start_session\": false", "\"auto_start_session\": \"true\"");
    ...
    fn missing_and_garbage_fields_fall_back_to_defaults() {
        ...
        assert_eq!(cfg.runtime_insight_kinds, vec!["cold_rewrites", "long_session"]);
