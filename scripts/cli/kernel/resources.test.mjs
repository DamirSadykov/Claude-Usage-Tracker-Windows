...
describe("bundle.resources covers the CLI import closure", () => {
  ...
  it("resolves the known gap that shipped in PR #95", () => {
    expect(closureOf("scripts/cli/board/todos.mjs").has("scripts/cli/kernel/board-recover.mjs")).toBe(true);
    expect(closureOf("scripts/cli/cc-hooks/stop-hook.mjs").has("scripts/cli/kernel/board-recover.mjs")).toBe(true);
  });
});
